...
const MyProjects = () => {
  ...
  return (
    ...
    <div className="flex justify-center sm:flex sm:justify-center md:flex md:justify-center lg:p-6 mb-20" data-aos="fade-right">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 justify-center gap-5 md:grid-cols-2 sm:grid-cols-1 p-2">
          <div className="bg-gray-800 lg:w-80 lg:h-auto rounded-lg p-1 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto ">
              <div className=" lg:w-auto md:w-auto sm:w-full w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg">
                <img src={Romanoff} alt="APV" className='h-full w-auto' />
              </div>
    ...
    <div className="flex justify-center "data-aos="fade-right">
     ...
     <div className="grid grid-cols-1 lg:grid-cols-3 justify-between gap-5 md:grid-cols-2 sm:grid-cols-1 lg:p-4 p-2"data-aos="fade-right">
        <div className="bg-gray-800 lg:w-80 lg:h-auto rounded-lg p-2 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto">
            <div className=" lg:w-auto md:w-auto sm:w-full  w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg ">
              <img src={APV} alt="APV" className=' h-full w-auto' />
            </div>
          ...
          <div className="bg-gray-800  lg:w-80 lg:h-auto rounded-lg p-3 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto"data-aos="fade-right">
            <div className=" lg:w-auto md:w-auto sm:w-full  w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg">
            <img src={CarS} alt="APV" className='h-full w-auto' />
            </div>
          ...
          <div className="bg-gray-800  lg:w-80 lg:h-auto rounded-lg p-3 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto"data-aos="fade-right">
            <div className=" lg:w-auto md:w-auto sm:w-full  w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg">
              <img src={Clients} alt="APV" className='h-full w-auto' />
            </div>
          ...
          <div className="bg-gray-800  lg:w-80 lg:h-auto rounded-lg p-3 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto"data-aos="fade-right">
            <div className="lg:w-auto md:w-auto sm:w-full  w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg">
            <img src={Crypto} alt="APV" className='h-full w-auto' />
            </div>
          ...
          <div className="bg-gray-800  lg:w-80 lg:h-auto rounded-lg p-3 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto"data-aos="fade-right">
            <div className=" lg:w-auto md:w-auto sm:w-full  w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg">
            <img src={imageSearch} alt="APV" className='h-full w-auto' />
            </div>
          ...
          <div className="bg-gray-800  lg:w-80 lg:h-auto rounded-lg p-3 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto"data-aos="fade-right">
            <div className="lg:w-auto md:w-auto sm:w-full  w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg">
            <img src={presupuesto} alt="APV" className='h-full w-auto' />
            </div>
          ...
          <div className="bg-gray-800  lg:w-80 lg:h-auto rounded-lg p-3 md:w-80 md:h-auto sm:w-96 sm:h-auto w-60 h-auto"data-aos="fade-right">
            <div className="lg:w-auto md:w-auto sm:w-full  w-full h-32 lg:h-44 md-h-44 sm:h-44 rounded-lg">
            <img src={Recipes} alt="APV" className='h-full w-auto' />
            </div>
